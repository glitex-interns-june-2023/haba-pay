                                ...
                                <div className="userprofile-accdetails">
                                        ...
                                        <div className="usersecondaryno">
                                            <div className="secondaryno-svg">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="49" viewBox="0 0 48 49" fill="none">
                                                    ...
                                                    <path d="M29.5 21.342C27.976 20.837 26.146 20.5 24 20.5C21.855 20.5 20.024 20.837 18.5 21.342M29.5 21.342C32.521 22.342 34.335 24.002 35 25L32.5 27.5L29.5 25.5V21.342ZM18.5 21.342C15.479 22.342 13.665 24.002 13 25L15.5 27.5L18.5 25.5V21.342Z" stroke="#323232" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                                </svg>
                                            </div>
                                    ...
                                    <div className="adminacc-actions">
                                        <div className="edit-userprofile">
                                            ...
                                            {isEditModalOpen && (
                                                <div className="modal">
                                                    <span className="close-btn" onClick={closeModals}>&times;</span>
                                                    <EditAccount />
                                                </div>
                                            )}
                                        </div>

                                        <div className="suspend-userprofile" onClick={openSuspendModal}>
                                            <div className="svg">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                                            ...
                                            <div className="userprofile-action" onClick={openSuspendModal}>
                                                <h2>Suspend</h2>
                                            </div>
                                        ...
                                        <div className="delete-userprofile" onClick={openDeleteModal}>
                                            <div className="svg">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                                            ...
                                            <div className="userprofile-action" onClick={openDeleteModal}>
                                                <h2>Delete</h2>
                                            </div>
