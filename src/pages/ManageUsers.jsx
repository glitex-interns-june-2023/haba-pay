...
const ManageUsers = () => {
    ...
    const loadSuspendedUsers = async () => {
        try {
            const response = await axios.get('https://habaapi.glitexsolutions.co.ke/api/v1/admins/users/suspended'); 
