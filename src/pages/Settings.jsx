                        ...
                        <div className="notification-details">
                            <div className="habapay-notifications">
                                ...
                                <div className="checkbox-notification">
                                    <svg className="check-browser" xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                    ...
                                    <svg className="check-email" xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                        <path d="M2 18.5C1.45 18.5 0.979002 18.304 0.587002 17.912C0.195002 17.52 -0.000664969 17.0493 1.69779e-06 16.5V2.5C1.69779e-06 1.95 0.196002 1.479 0.588002 1.087C0.980002 0.695002 1.45067 0.499335 2 0.500002H16C16.55 0.500002 17.021 0.696002 17.413 1.088C17.805 1.48 18.0007 1.95067 18 2.5V16.5C18 17.05 17.804 17.521 17.412 17.913C17.02 18.305 16.5493 18.5007 16 18.5H2ZM7.6 13.275C7.73334 13.275 7.85834 13.254 7.975 13.212C8.09167 13.17 8.2 13.0993 8.3 13L13.975 7.325C14.1583 7.14167 14.25 6.91667 14.25 6.65C14.25 6.38333 14.15 6.15 13.95 5.95C13.7667 5.76667 13.5333 5.675 13.25 5.675C12.9667 5.675 12.7333 5.76667 12.55 5.95L7.6 10.9L5.425 8.725C5.24167 8.54167 5.01667 8.45 4.75 8.45C4.48334 8.45 4.25 8.55 4.05 8.75C3.86667 8.93334 3.775 9.16667 3.775 9.45C3.775 9.73334 3.86667 9.96667 4.05 10.15L6.9 13C7 13.1 7.10834 13.1707 7.225 13.212C7.34167 13.2533 7.46667 13.2743 7.6 13.275Z" fill="#FDAC15"/>
                                    </svg>

                                    <svg className="check-text" xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                        <path d="M2 18.5C1.45 18.5 0.979002 18.304 0.587002 17.912C0.195002 17.52 -0.000664969 17.0493 1.69779e-06 16.5V2.5C1.69779e-06 1.95 0.196002 1.479 0.588002 1.087C0.980002 0.695002 1.45067 0.499335 2 0.500002H16C16.55 0.500002 17.021 0.696002 17.413 1.088C17.805 1.48 18.0007 1.95067 18 2.5V16.5C18 17.05 17.804 17.521 17.412 17.913C17.02 18.305 16.5493 18.5007 16 18.5H2ZM7.6 13.275C7.73334 13.275 7.85834 13.254 7.975 13.212C8.09167 13.17 8.2 13.0993 8.3 13L13.975 7.325C14.1583 7.14167 14.25 6.91667 14.25 6.65C14.25 6.38333 14.15 6.15 13.95 5.95C13.7667 5.76667 13.5333 5.675 13.25 5.675C12.9667 5.675 12.7333 5.76667 12.55 5.95L7.6 10.9L5.425 8.725C5.24167 8.54167 5.01667 8.45 4.75 8.45C4.48334 8.45 4.25 8.55 4.05 8.75C3.86667 8.93334 3.775 9.16667 3.775 9.45C3.775 9.73334 3.86667 9.96667 4.05 10.15L6.9 13C7 13.1 7.10834 13.1707 7.225 13.212C7.34167 13.2533 7.46667 13.2743 7.6 13.275Z" fill="#FDAC15"/>
                                    </svg>
                                </div>
                            </div>
                            ...
                            <div className="habapay-notifications">
                                ...
                                <div className="checkbox-notification">
                                    <svg className="check-browser1" xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                        <path d="M2 18.5C1.45 18.5 0.979002 18.304 0.587002 17.912C0.195002 17.52 -0.000664969 17.0493 1.69779e-06 16.5V2.5C1.69779e-06 1.95 0.196002 1.479 0.588002 1.087C0.980002 0.695002 1.45067 0.499335 2 0.500002H16C16.55 0.500002 17.021 0.696002 17.413 1.088C17.805 1.48 18.0007 1.95067 18 2.5V16.5C18 17.05 17.804 17.521 17.412 17.913C17.02 18.305 16.5493 18.5007 16 18.5H2ZM7.6 13.275C7.73334 13.275 7.85834 13.254 7.975 13.212C8.09167 13.17 8.2 13.0993 8.3 13L13.975 7.325C14.1583 7.14167 14.25 6.91667 14.25 6.65C14.25 6.38333 14.15 6.15 13.95 5.95C13.7667 5.76667 13.5333 5.675 13.25 5.675C12.9667 5.675 12.7333 5.76667 12.55 5.95L7.6 10.9L5.425 8.725C5.24167 8.54167 5.01667 8.45 4.75 8.45C4.48334 8.45 4.25 8.55 4.05 8.75C3.86667 8.93334 3.775 9.16667 3.775 9.45C3.775 9.73334 3.86667 9.96667 4.05 10.15L6.9 13C7 13.1 7.10834 13.1707 7.225 13.212C7.34167 13.2533 7.46667 13.2743 7.6 13.275Z" fill="#FDAC15"/>
                                    </svg>
                            ...
                            <div className="habapay-notifications">
                                ...
                                <div className="checkbox-notification">
                                    <svg className="check-browser2" xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                            ...
                            <div className="habapay-notifications">
                                ...
                                <div className="checkbox-notification">
                                    <svg className="check-browser3" xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                        <path d="M2 18.5C1.45 18.5 0.979002 18.304 0.587002 17.912C0.195002 17.52 -0.000664969 17.0493 1.69779e-06 16.5V2.5C1.69779e-06 1.95 0.196002 1.479 0.588002 1.087C0.980002 0.695002 1.45067 0.499335 2 0.500002H16C16.55 0.500002 17.021 0.696002 17.413 1.088C17.805 1.48 18.0007 1.95067 18 2.5V16.5C18 17.05 17.804 17.521 17.412 17.913C17.02 18.305 16.5493 18.5007 16 18.5H2ZM2 16.5H16V2.5H2V16.5Z" fill="#898989"/>
                                    </svg>
                            ...
                            <div className="habapay-notifications">
                                ...
                                <div className="checkbox-notification">
                                    <svg className="check-browser4" xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                        <path d="M2 18.5C1.45 18.5 0.979002 18.304 0.587002 17.912C0.195002 17.52 -0.000664969 17.0493 1.69779e-06 16.5V2.5C1.69779e-06 1.95 0.196002 1.479 0.588002 1.087C0.980002 0.695002 1.45067 0.499335 2 0.500002H16C16.55 0.500002 17.021 0.696002 17.413 1.088C17.805 1.48 18.0007 1.95067 18 2.5V16.5C18 17.05 17.804 17.521 17.412 17.913C17.02 18.305 16.5493 18.5007 16 18.5H2ZM2 16.5H16V2.5H2V16.5Z" fill="#898989"/>
                                    </svg>
